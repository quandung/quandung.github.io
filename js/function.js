...
$(document).on('ready', function () {
    ...
    // JavaScript Document
   var today = new Date();
   var target = new Date('02/02/2024 13:00:00'); //Enter Target date & time - MM/DD/YYYY hh:mm:ss
   ...
   if ($.find('#example').length) {
       $('#example').countdown({
           date: new Date('02/02/2024 13:00:00') , //Enter Target date & time - MM/DD/YYYY hh:mm:ss
           offset: +5.5,
           day: 'Day',
           days: 'Days'
       }, function () {
