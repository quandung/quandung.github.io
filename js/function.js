...
$(document).on('ready', function () {
    ...
    // JavaScript Document
   var today = new Date();
   var target = new Date('05/07/2024 18:00:00'); //Enter Target date & time - MM/DD/YYYY hh:mm:ss
   ...
   if ($.find('#example').length) {
       $('#example').countdown({
           date: new Date('05/07/2024 18:00:00') , //Enter Target date & time - MM/DD/YYYY hh:mm:ss
           offset: +5.5,
           day: 'Day',
           days: 'Days'
       }, function () {
